...
class NamesiloUsers
{
    ...
    /**
     * Creates a new user account at Namesilo under this ApiUser. NOTE: Use
     ...
     *  - AcceptNews Possible values are 0 and 1. Value should be 1 if the user wants to recieve newsletters else
     *      it should be 0.
    ...
    {
        return $this->api->submit('namesilo.users.create', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.getPricing', $vars);
    }
     ...
     * needed in your Namesilo account to complete auto renewal.
     *
     * @return NamesiloResponse
     */
    public function getBalances()
    {
        return $this->api->submit('namesilo.users.getBalances');
    }
    ...
    {
        return $this->api->submit('namesilo.users.changePassword', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.update', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.createAddFundsRequest', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.getAddFundsStatus', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.login', $vars);
    }
    ...
    {
        return $this->api->submit('namesilo.users.resetPassword', $vars);
    }
}
